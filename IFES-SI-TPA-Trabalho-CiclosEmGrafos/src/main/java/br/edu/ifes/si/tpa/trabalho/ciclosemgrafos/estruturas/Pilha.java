...
/**
 * ****************************************************************************
 * Compilation: javac Stack.java Execution: java Stack < input.txt Dependencies:
 * StdIn.java StdOut.java
 *
 * A generic stack, implemented using a singly-linked list. Each stack element
 * is of type Item.
 *
 * This version uses a static nested class Node (to save 8 bytes per Node),
 * whereas the version in the textbook uses a non-static nested class (for
 * simplicity).
 *
...
/**
 * The <tt>Pilha</tt> class represents a last-in-primeiro-out (LIFO) stack of
 * generic items. It supports the usual <em>empilha</em> and <em>desempilha</em>
 ...
 * that uses a non-static nested class. The <em>empilha</em>,
 * <em>desempilha</em>, <em>primeiro</em>, <em>tamanho</em>, and
 * <em>is-empty</em>
