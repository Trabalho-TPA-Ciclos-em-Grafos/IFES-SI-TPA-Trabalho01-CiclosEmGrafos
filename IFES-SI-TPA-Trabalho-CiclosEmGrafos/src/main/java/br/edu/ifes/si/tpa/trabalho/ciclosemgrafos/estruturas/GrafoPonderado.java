package br.edu.ifes.si.tpa.trabalho.ciclosemgrafos.estruturas;

/**
 * *****************************************************************************
 * Compilação: javac GrafoPonderado.java Execução: java GrafoPonderado dados.txt
 * Dependências: Aresta.java Vertice.java Arquivos de dados: GrafoPonderado1.txt
 *
 * Um grafo ponderado de arestas, implementado utilizando listas de adjacências.
 *
 * % java GrafoPonderado GrafoPonderado1.txt 8 16 0: 0-6 0,58000 0-2 0,26000 0-4
 * 0,38000 0-7 0,16000 1: 1-3 0,29000 1-2 0,36000 1-7 0,19000 1-5 0,32000 2: 2-6
 * 0,40000 2-7 0,34000 2-1 0,36000 2-0 0,26000 2-3 0,17000 3: 3-6 0,52000 3-1
 * 0,29000 3-2 0,17000 4: 4-6 0,93000 4-0 0,38000 4-7 0,37000 4-5 0,35000 5: 5-1
 * 0,32000 5-7 0,28000 5-4 0,35000 6: 6-4 0,93000 6-0 0,58000 6-3 0,52000 6-2
 * 0,40000 7: 7-2 0,34000 7-1 0,19000 7-0 0,16000 7-5 0,28000 7-4 0,37000
 *
 *****************************************************************************
 */
...
/**
 * Esta classe implementa a representação do grafo ponderado com lista de
 * adjacências. Para documentação adicional, acesse:
