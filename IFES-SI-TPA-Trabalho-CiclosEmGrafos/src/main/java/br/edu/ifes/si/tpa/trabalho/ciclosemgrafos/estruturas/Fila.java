...
/**
 * The <tt>Fila</tt> class represents a primeiro-in-primeiro-out (FIFO) queue of
 * generic items. It supports the usual <em>enfileira</em> and
 * <em>desenfileira</em>
 * operations, along with methods for peeking at the primeiro item, testing if
 ...
 * that uses a non-static nested class. The <em>enfileira</em>,
 * <em>desenfileira</em>, <em>primeiro</em>, <em>tamanho</em>, and
 * <em>is-empty</em>
...
public class Fila<Item> implements Iterable<Item> {
    ...
    public Item desenfileira() {
        ...
        n--;
        if (isEmpty()) {
            ultimo = null;   // to avoid loitering
        }
        return item;
    }
